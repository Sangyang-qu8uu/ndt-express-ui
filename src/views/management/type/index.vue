<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="typeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="准载重量(吨)" align="center" prop="allowableLoad" />
      <el-table-column label="准载体积(立方米)" align="center" prop="allowableVolume" />
      <el-table-column label="长(米)" align="center" prop="measureLong" />
      <el-table-column label="宽(米)" align="center" prop="measureWidth" />
      <el-table-column label="高(米)" align="center" prop="measureHigh" />
      <el-table-column label="车型数量" align="center" prop="num" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="准载重量" prop="allowableLoad">
          <el-input v-model="form.allowableLoad" placeholder="请输入准载重量" />
        </el-form-item>
        <el-form-item label="准载体积" prop="allowableVolume">
          <el-input v-model="form.allowableVolume" placeholder="请输入准载体积" />
        </el-form-item>
...
<script>
import { listType, getType, delType, addType, updateType } from "@/api/management/type";
